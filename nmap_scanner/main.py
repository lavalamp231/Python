...
slocal_ip = local_ip.split(".")
str_local_subnet = str(slocal_ip[0] + "." + slocal_ip[1] +"."+ slocal_ip[2]+ ".*")
print(str_local_subnet)

# Gathering all the IPs in local subnet and then appending them into an empty list called ips

ips = []
nm = nmap3.Nmap()
nm_scan = nmap3.NmapScanTechniques()
host_discovery_results = nm_scan.nmap_ping_scan(str_local_subnet)
...
excel_location = (cwd +'\\nmap_version_detection_'+ today + '.xlsx')
